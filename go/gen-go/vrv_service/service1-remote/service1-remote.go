...
var _ = vrv_service.GoUnusedProtection__

func Usage() {
  fmt.Fprintln(os.Stderr, "Usage of ", os.Args[0], " [-h host:port] [-u url] [-f[ramed]] function [arg1 [arg2...]]:")
  flag.PrintDefaults()
  fmt.Fprintln(os.Stderr, "\nFunctions:")
  fmt.Fprintln(os.Stderr, "  Service1HelloResponse hello(Service1HelloReuqest request)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := vrv_service.NewService1Client(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "hello":
    ...
    argvalue0 := vrv_service.NewService1HelloReuqest()
